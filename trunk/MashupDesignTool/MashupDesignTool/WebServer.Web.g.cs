...
namespace WebServer.Web
{
    ...
    /// </summary>
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/WebServer.Web")]
    ...
    public sealed partial class UserRegistrationContext : DomainContext
    {
        ...
        public UserRegistrationContext() : 
                this(new WebDomainClient<IUserRegistrationServiceContract>(new Uri("WebServer-Web-UserRegistrationService.svc", UriKind.Relative)))
        {
        }
