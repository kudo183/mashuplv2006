...
namespace NewsReaderControl.ServiceReference1 {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IService1Channel : NewsReaderControl.ServiceReference1.IService1, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Service1Client : System.ServiceModel.ClientBase<NewsReaderControl.ServiceReference1.IService1>, NewsReaderControl.ServiceReference1.IService1 {
        ...
        System.IAsyncResult NewsReaderControl.ServiceReference1.IService1.BeginGetStringFromURL(string url, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetStringFromURL(url, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string NewsReaderControl.ServiceReference1.IService1.EndGetStringFromURL(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetStringFromURL(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((NewsReaderControl.ServiceReference1.IService1)(this)).BeginGetStringFromURL(url, callback, asyncState);
        }
        
        private object[] OnEndGetStringFromURL(System.IAsyncResult result) {
            string retVal = ((NewsReaderControl.ServiceReference1.IService1)(this)).EndGetStringFromURL(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult NewsReaderControl.ServiceReference1.IService1.BeginGetDataFromURL(string url, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetDataFromURL(url, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        byte[] NewsReaderControl.ServiceReference1.IService1.EndGetDataFromURL(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetDataFromURL(object[] inValues, System.AsyncCallback callback, object asyncState) {
            string url = ((string)(inValues[0]));
            return ((NewsReaderControl.ServiceReference1.IService1)(this)).BeginGetDataFromURL(url, callback, asyncState);
        }
        
        private object[] OnEndGetDataFromURL(System.IAsyncResult result) {
            byte[] retVal = ((NewsReaderControl.ServiceReference1.IService1)(this)).EndGetDataFromURL(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override NewsReaderControl.ServiceReference1.IService1 CreateChannel() {
            return new Service1ClientChannel(this);
        }
        
        private class Service1ClientChannel : ChannelBase<NewsReaderControl.ServiceReference1.IService1>, NewsReaderControl.ServiceReference1.IService1 {
            
            public Service1ClientChannel(System.ServiceModel.ClientBase<NewsReaderControl.ServiceReference1.IService1> client) : 
                    base(client) {
            }
