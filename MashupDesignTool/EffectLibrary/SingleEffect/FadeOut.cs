...
{
    public class FadeOut : BasicDisappearEffect
    {
        #region attributes
        ...
        public FadeOut(EffectableControl control)
            : base(control)
        {
        ...
        private void InitStoryboard()
        {
            ...
            DoubleAnimation doubleAnimation = new DoubleAnimation() { BeginTime = beginTime, Duration = duration, From = 1, To = 0 };
