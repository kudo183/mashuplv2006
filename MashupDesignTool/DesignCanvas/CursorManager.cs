...
namespace MashupDesignTool
{
    class CursorManager
    {
        ...
        private static CustomCursor cursorSizeENWS = new CustomCursor(@"/MashupDesignTool;component/Images/SizeENWS.png");
        private static CustomCursor cursorSizeWNES = new CustomCursor(@"/MashupDesignTool;component/Images/SizeWNES.png");
